local function RegisterDefaultSpecialWeps()
	...
	nzSpecialWeapons:AddKnife("tfa_cso_jaysdagger", true, 2, 2)
	...
	nzSpecialWeapons:AddGrenade("tfa_cso_sfgrenade", 4, false, 1, false, 1.82)
	nzSpecialWeapons:AddGrenade("tfa_cso_mooncake", 8, false, 1, false, 2.5)
	nzSpecialWeapons:AddGrenade("tfa_cso_holybomb_refined", 3, false, 1, false, 1.79)
	nzSpecialWeapons:AddGrenade("tfa_cso_m24grenade", 4, false, 1, false, 1.75)
	nzSpecialWeapons:AddGrenade("tfa_cso_heartbomb", 3, false, 1, false, 1.44)
	nzSpecialWeapons:AddGrenade("tfa_cso_cake", 2, false, 1, false, 2)
	nzSpecialWeapons:AddGrenade("tfa_cso_fragnade", 4, false, 1, false, 1.75)
	nzSpecialWeapons:AddGrenade("tfa_cso_chaingrenade", 4, false, 1, false, 1.87)
	nzSpecialWeapons:AddGrenade("tfa_cso_cartfrag", 4, false, 1, false, 1.44)
	
	nzSpecialWeapons:AddSpecialGrenade("nz_monkey_bomb", 3, false, 3, false, 0.4)
	nzSpecialWeapons:AddSpecialGrenade("tfa_cso_trinity_flame", 3, false, 1, false, 1.5)
	nzSpecialWeapons:AddSpecialGrenade("tfa_cso_trinity_stun", 5, false, 1, false, 1.5)
	
	nzSpecialWeapons:AddDisplay("nz_revive_morphine", false, function(wep) return not (IsValid(wep.Owner:GetPlayerReviving()) and wep.Owner:KeyDown(IN_USE)) end)
	nzSpecialWeapons:AddDisplay("nz_perk_bottle", false, function(wep) return SERVER and CurTime() > wep.nzDeployTime + 3.1 end)
	nzSpecialWeapons:AddDisplay("nz_packapunch_arms", false, function(wep) return SERVER and CurTime() > wep.nzDeployTime + 2.5 end)
end
